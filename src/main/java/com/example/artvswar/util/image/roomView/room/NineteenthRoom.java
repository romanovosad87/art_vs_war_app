...
public class NineteenthRoom implements RoomViewProvider {
    private static final int UNDERLAY_PIXEL_WIDTH = 1418;
    private static final int UNDERLAY_IN_CENTIMETERS_WIDTH = 180;
    private static final long UNDERLAY_ROOM_ID = 19L;
    ...
    public RoomView getRoom(String publicId, double paintingWidth, double paintingHeight) {
        ...
        long yValue = Math.round(-140 + ((paintingHeight - 19) / 16) * 60);
        long xValue = -240;
