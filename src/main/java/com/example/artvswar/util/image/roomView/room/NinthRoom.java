...
public class NinthRoom implements RoomViewProvider {
    ...
    public RoomView getRoom(String publicId, double paintingWidth, double paintingHeight) {
        ...
        long yValue = Math.round(-150 + ((paintingHeight - 34) / 46) * 80);
        long xValue = 70;
        if (paintingWidth <= 80 && paintingWidth > 34 && paintingHeight <= 80 && paintingHeight > 34) {
